...
async def main():
 async with async_playwright() as p:
  ...
  for label,w,h,reduce in [('desktop',1440,1000,False),('mobile',390,844,False),('small',360,740,False),('reduced',1440,1000,True)]:
   ...
   await page.goto(BASE+'/next/request/#c=broken',wait_until='networkidle')
   await expect(page.locator('.nx-error-page[role="alert"]')).to_be_visible()
   await expect(page.locator('.nx-error-page')).to_contain_text('הקישור פגום')
